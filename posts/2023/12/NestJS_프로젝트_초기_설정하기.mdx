...
[tsconfig.json 설정하기](https://daphne-dev.github.io/2023/10/09/JS_TS/TypeScript/tsconfig_json_설정하기/)

## npm vs yarn vs pnpm

node에는 node_modules를 관리해주는 패키지 관리자가 있는데 초기에 npm 하나만 있었지만 현재는 yarn과 그 이후에 나온 pnpm까지 3개 중 1개를 선택해야 하는 시대가 왔다.

[npm vs yarn vs pnpm 비교](https://daphne-dev.github.io/2023/10/10/Node.js/npm_vs_yarn_vs_pnpm_비교/)
