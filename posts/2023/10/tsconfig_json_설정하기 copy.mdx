...
- undefined(기본 값) : 경고로 접근할 수 없는 코드가 있다고 제안 제공
  ![](/static/images/tsconfig-001.png)
- true : 접근할 수 없는 코드에 대해 무시(알려주지 않음, 정상 컴파일)
  ![](/static/images/tsconfig-002.png)
- false : 접근할 수 없는 코드에 대해 컴파일러 오류 발생
  ![](/static/images/tsconfig-003.png)

### allowUnusedLabels

- undefined(기본 값) : 사용되지 않는 레이블이라고 제안 제공
  ![](/static/images/tsconfig-004.png)
- true : 사용되지 않는 레이블에 대해 무시
  ![](/static/images/tsconfig-005.png)
- false : 사용되지 않는 레이블에 대해 컴파일 오류 발생
  ![](/static/images/tsconfig-006.png)
...
![](/static/images/tsconfig-007.png)

### noFallthroughCasesInSwitch

![](/static/images/tsconfig-008.png)
...
![](/static/images/tsconfig-009.png)
...
![](/static/images/tsconfig-010.png)
...
![](/static/images/tsconfig-011.png)
...
![](/static/images/tsconfig-012.png)
...
![](/static/images/tsconfig-013.png)
...
![](/static/images/tsconfig-014.png)
...
![](/static/images/tsconfig-015.png)
...
![](/static/images/tsconfig-016.png)
...
![](/static/images/tsconfig-017.png)
...
![](/static/images/tsconfig-018.png)
...
![](/static/images/tsconfig-019.png)
...
![](/static/images/tsconfig-020.png)
...
- true
  ![](/static/images/tsconfig-021.png)
- false(기본 값)
  ![](/static/images/tsconfig-022.png)
